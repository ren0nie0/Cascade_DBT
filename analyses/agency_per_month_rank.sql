...
select ROUND(CAST(num_of_sightings as FLOAT)*1.0/CAST(total_num_of_sightings AS FLOAT),3)*10 as probability , c.sighting_month as sighting_month, city_agent
